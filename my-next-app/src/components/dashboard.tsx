                ...
                <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                  <div className="p-4 bg-white rounded-lg shadow" >
                    ...
                    <div className="mt-4 flex justify-between">
                      <button
                        className={`px-4 py-2 ${viewType === 'weekly' ? 'bg-gray-700 rounded-md ' : 'bg-gray-200 hover:bg-gray-700'} text-white rounded`}
                        onClick={() => setViewType('weekly')}
                      >
                        Weekly
                      </button>
                      <button
                        className={`px-4 py-2 ${viewType === 'monthly' ? 'bg-gray-700  rounded-md' : 'bg-gray-200 hover:bg-gray-700'} text-white rounded`}
                        onClick={() => setViewType('monthly')}
                      >
                        Monthly
                      </button>
                      <button
                        className={`px-4 py-2 ${viewType === 'yearly' ? 'bg-gray-700 rounded-md' : 'bg-gray-200 hover:bg-gray-700'} text-white rounded`}
